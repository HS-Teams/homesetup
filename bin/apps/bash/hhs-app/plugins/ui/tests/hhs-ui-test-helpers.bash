setup() {
  ...
  cache_runtime_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/execution/cache_runtime.py"
  ...
  monitor_runtime_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/features/monitor_runtime.py"
  path_picker_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/widgets/path_picker.py"
  status_ui_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/widgets/status_ui.py"
  table_ui_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/widgets/table_ui.py"
  terminal_ui_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/widgets/terminal_ui.py"
  constants_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/constants.py"
  paths_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/paths.py"
  process_resources_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/process_resources.py"
  runtime_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/runtime.py"
  search_core_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/features/search_core.py"
  search_ui_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/features/search_ui.py"
  ssh_runtime_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/features/ssh_runtime.py"
  ssh_core_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/features/ssh_core.py"
  theme_assets_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/theme_assets.py"
  ui_state_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/core/ui_state.py"
  css_file="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/static/css/streamlit_ui.css"
  themes_dir="${HHS_REPO_DIR}/bin/apps/py/hhs_ui/static/themes"
  ...
  monitor_runtime_source="$(<"${monitor_runtime_file}")"
