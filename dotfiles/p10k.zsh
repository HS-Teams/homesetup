...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_STAGED_FOREGROUND=82
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_FOREGROUND=203
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=45
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=214
  ...
  function my_git_formatter() {
    ...
    # cores
    local clean='%255F'         # branco
    local modified='%51F'       # azul neon
    local untracked='%45F'      # ciano neon
    local conflicted='%203F'    # vermelho claro
    local meta='%7F'            # cinza leve
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=19
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=255
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=54
  ...
  typeset -g POWERLEVEL9K_TIME_CONTENT_EXPANSION='%D{%H:%M}'
  typeset -g POWERLEVEL9K_TIME_SUFIX=''
